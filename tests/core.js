...
exports.complexOptions = function() {
    ...
    TestRun()
        .addError(2, "Unknown complex option 'complex'.")
        .addError(3, "Unknown option 'x'.")
        .addError(7, "Unknown complex option 'complex'.")
        .addError(8, "Unknown option 'x'.")
        .addError(9, "Unknown option 'y'.")
        .addError(17, "Unknown complex option 'complex'.")
        .addError(18, "Unknown option 'a'.")
        .addError(19, "Unknown option 'b'.")
        .addError(20, "Unknown option 'c'.")
        .addError(21, "Unknown option 'd'.")
        .addError(26, "Bad option value.")
        .addError(28, "Bad option.")
        .addError(28, "Missing option value.")
        .test(src);
};
